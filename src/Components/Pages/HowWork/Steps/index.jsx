  ...
  return (
    <StepsWrapper>
      <Container>
        ...
        <div className="step2" id="step2">
          <div className="ttop">
            ...
            <div className="left">
              ...
              <p>
                Outsourcing is the highest form of delegation of your processes
                to the remote office. Due to the remote work nature of
                offshoring, you need to get fit and ready, so your processes
                need to be tidied up to be able to work with an offshore team.{" "}
              </p>
              <p>So, let`s check:</p>
          <p>Do you possess:</p>
          <ul>
            ...
            <li>
              ...
              CRMs and programs that are accessible in a remote work setting or
              a different location, such as Uzbekistan{" "}
            </li>
            <li>
              <span>
                <div className="in"></div>
          ...
          <p>
            ...
            doesn`t mean outsourcing isn`t the solution for you, it simply means
            that you may need to invest more in getting your business offshore
            fit. We are more than happy to discuss your business plans and
            provide advice on how you can get started.
          </p>
          <p>
            If you answered yes to all of these questions, then offshoring could
            be the solution for you and it`s time to begin discussions with one
            of our business development managers. In these discussions, we will
            ask you about your offshore team, IT, and infrastructure
            requirements as these factors will be crucial to getting started.{" "}
          </p>
          ...
          <ul>
            <li>
              ...
              Who will your offshore team members report to within your onshore
              team?
            </li>
            <li>
              <span>
            ...
            <li>
              ...
              What IT programs do you use? (professional software, ERP and CRMs,
              etc.)
            </li>
            <li>
              <span>
              ...
              How many offshore team members do you need and in what functions?
            </li>
            <li>
              <span>
                <div className="in"></div>
              </span>
              Are you looking to reduce costs, in particular, employment costs?
            </li>
            <li>
              <span>
                <div className="in"></div>
          ...
          <p>
            ...
            and systems knowledge, years of experience within similar roles, and
            what hours of work they will be required to perform.
          </p>
          <p>
            These components are essential in creating your ideal offshore
            candidate profiles, which then get passed onto our recruitment team
            to understand the costs of setting up your offshore team. We will
            then share a transparent and fully itemized cost proposal outlining
            the costs associated with your offshore team so you can then
            determine if our offshoring solution fits your business
            requirements.
          </p>
        </div>
        ...
        <div className="right">
            <img src="/illustrator/3.jpg" alt="" />
          </div>
          <div className="left">
            <div className="top">
              <span>03</span>
              <h3>
                Recruit people from the existing and potential candidates{" "}
              </h3>
            </div>
            <p>
        ...
        <div className="step4 step3" id="step4">
          ...
          <div className="right">
            <img src="/illustrator/4.jpg" alt="" />
          </div>
        </div>

        <div className="step5 step3" id="step5">
          
          <div className="right">
            <img src="/illustrator/5.jpg" alt="" />
          </div>
          <div className="left">
            <div className="top">
              <span>05</span>
        ...
        <div className="step6 step3" id="step6">
          ...
          <div className="right">
            <img src="/illustrator/6.jpg" alt="" />
          </div>
        </div>

        <div className="step7 step3" id="step7">
         
          <div className="right">
            <img src="/illustrator/7.jpg" alt="" />
          </div>
          <div className="left">
            <div className="top">
              <span>07 </span>
        ...
        <div className="step8 step2" id="step8">
          <div className="ttop">
          ...
          <ul>
            ...
            <li>
              ...
              Ensure staff productivity levels are high through monitoring work
              habits
            </li>
            <li>
              <span>
            ...
            <div className="right">
              <img src="/illustrator/8.jpg" alt="" />
            </div>
          </div>
          
          <p>
            While we handle all of this, you retain as much control of quality
            and productivity as you would like. In other words, we take care of
            everything on the ground, enabling you to focus purely on the
            business processes you want to run out of Uzbekistan.{" "}
          </p>
          <p>
            It`s important to note that for your offshore team to work, you need
            to put in the time and effort to train them up and get them across
            all of your systems and processes. What our offshore management team
            does is provide the back-end support to facilitate this. If you
            don`t invest in establishing, developing and maintaining your
            offshore team, then your offshore investments may not be as
            successful as they could be.{" "}
          </p>
          <p>
            Learn more about how you can work with your offshore team to achieve
